            ...
            <div class="posts col-8">
                ...
                <div class="row add_post">
                    ...
                    <form action="create.php" method="post" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col">
                                <input name="title" type="text" class="form-control" placeholder="Title" aria-label="Title" value="<?= $title ?>">
                            </div>
                            <div class="mb-3">
                                <label for="post_content" class="form-label">content</label>
                                <textarea name="content" class="form-control" id="post_content" rows="3"><?= $content ?></textarea>
                            </div>
                            ...
                            <div class="col-5">
                                <button name="create_post" class="btn btn-primary" type="submit" style="float: right;">create post</button>
                            </div>
                        </div>
                    </form>
                </div>
