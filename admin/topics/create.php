            ...
            <div class="posts col-8">
                ...
                <div class="row add_post">
                    <form action="create.php" method="post">
                        <div class="row g-3">
                            <div class="col-10">
                                <input type="text" class="form-control" placeholder="Title" aria-label="Title" name="topic_name">
                            </div>
                            <div class="col">
                                <button class="btn btn-primary" type="submit" name="topic_create">save</button>
                            </div>
                        </div>
                    </form>
                </div>
